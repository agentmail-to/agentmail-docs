...
description: "Build a conversational email agent with AgentMail by creating an inbox, sending a message, receiving events, preserving threads, and replying in context."
---
