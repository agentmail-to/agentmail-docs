...
# Schedule for next business day at 9 AM UTC
...
<Callout intent="info">
For more details on scheduled sending—including how to cancel, reschedule, list scheduled drafts, and build conditional follow-up workflows—see the [**Drafts**](/drafts) core concept page and the [**Scheduled & Conditional Sending**](/scheduled-sending) guide.
</Callout>
