...
slug: imap-smtp
description: "Connect AgentMail inboxes to email clients and third-party tools through standard IMAP and SMTP, with credentials, ports, security, and setup examples."
---
