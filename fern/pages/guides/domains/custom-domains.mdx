...
slug: custom-domains
description: "Configure a custom sending domain in AgentMail, add the required DNS records, verify ownership, and improve the identity and deliverability of agent email."
---
