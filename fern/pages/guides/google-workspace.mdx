...
description: "Route unrecognized Google Workspace addresses to AgentMail while keeping existing mailboxes intact, using split delivery, DNS records, and Gmail routing."
---
