...
<Note title="Browser enrollment migration">
  For organizations explicitly enabled for the limited beta, [AgentID browser
  enrollment](/agentid-browser-enrollment) is the successor for persistent
  browser approval. This public-key flow remains supported during migration;
  no deprecation date has been announced.
</Note>
