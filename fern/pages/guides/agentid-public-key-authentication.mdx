...
description: "Register scoped P-256 public keys for AgentID sign-in, keep private keys in secure storage, and submit signed approval assertions without exposing secrets."
---
