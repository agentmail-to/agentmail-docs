...
slug: multi-tenancy
description: "Design multi-tenant email infrastructure with AgentMail using Pods, scoped API keys, isolated inboxes, custom domains, permissions, and resource boundaries."
---
