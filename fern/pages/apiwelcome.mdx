...
slug: api-reference
description: "Explore the AgentMail API and SDKs for creating agent inboxes, sending and receiving email, managing threads and drafts, and building automated workflows."
---
