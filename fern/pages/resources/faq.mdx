...
slug: faq
description: "Find answers to common AgentMail questions about inboxes, sending and receiving email, security, deliverability, API behavior, billing, and agent workflows."
---
