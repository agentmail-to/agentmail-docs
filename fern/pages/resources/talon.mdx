...
description: "Use Talon with AgentMail to extract new reply content from email threads, remove quoted history and signatures, and give agents cleaner text to process."
---
