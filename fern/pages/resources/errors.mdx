...
slug: errors
description: "Understand every AgentMail API error code, response field, likely cause, and recommended fix so agents can recover from failed requests safely and reliably."
---
