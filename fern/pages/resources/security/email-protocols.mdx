...
<Note>
As of July 6, 2026, newly created domains use DKIM TXT records. Older domains may still use DKIM CNAME records, so always publish the exact record type AgentMail returns.
</Note>
