...
description: "Understand SPF, DKIM, and DMARC email authentication, why AgentMail requires DNS records, and how these protocols protect sender identity and delivery."
---
