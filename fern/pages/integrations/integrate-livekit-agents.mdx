...
description: "Build a LiveKit voice assistant with AgentMail tools so it can send email during conversations, using a practical Python integration guide and example."
---
