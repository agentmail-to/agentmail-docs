...
- [AgentMail MCP Server](#agentmail-mcp-server)
- [AgentMail Docs for Agents](#agentmail-docs-for-agents)
- [AgentMail Skills](#agentmail-skills)
...
<Info>
  AgentMail's free tier includes 3 inboxes and 100 emails/day （no credit card required）. Your agent can start building immediately.
</Info>
...
<CardGroup>
  ...
  <Card title="Example: Auto-Reply Agent" icon="fa-solid fa-bolt" href="/documentation/examples/auto-reply-agent">
    Build an agent that responds to emails in real-time.
  </Card>

  <Card title="FAQ" icon="fa-solid fa-book" href="/docs/resources/faq">
