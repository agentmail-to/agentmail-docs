...
<Info>
  AgentMail's free tier includes 3 inboxes and 3,000 emails/month — no credit card required. Your agent can start building immediately.
</Info>
...
<Card title="MCP Server on GitHub" icon="fa-brands fa-github" href="https://github.com/agentmail-to/agentmail-mcp">
