...
[X Layer](https://www.okx.com/x-layer) is an Ethereum Layer 2 network built with Polygon CDK, offering high throughput and near-zero gas fees. Agents on X Layer can pay for API usage directly over HTTP via x402.
