...
Agents on X Layer can pay for API usage directly over HTTP via x402. [X Layer](https://web3.okx.com/xlayer) is an Ethereum Layer 2 network built with Polygon CDK, offering high throughput and near-zero gas fees.
