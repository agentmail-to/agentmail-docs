...
description: "Use AgentMail through the x402 payment protocol so autonomous agents can pay for email API usage over HTTP on supported blockchain networks at runtime."
---
