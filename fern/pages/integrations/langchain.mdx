...
description: "Use the LangChain AgentMail integration to give LangGraph agents real inboxes plus tools for sending, replying, drafting, labeling, and searching email."
---
