...
description: "Install the official AgentMail skill in Claude Code, Cursor, Codex, OpenClaw, and compatible assistants to add inbox and email tools to AI agents quickly."
---
