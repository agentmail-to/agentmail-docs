...
description: "Connect Claude, Cursor, and other MCP clients to AgentMail with OAuth or an API key so agents can manage inboxes, messages, threads, and attachments securely."
---
