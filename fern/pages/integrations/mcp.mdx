...
The catalog covers inboxes, threads, messages, search, drafts, attachments, and authenticated identity. OAuth sessions can also receive organization-selection tools.
