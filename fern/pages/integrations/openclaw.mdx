...
description: "Give an OpenClaw agent a real email inbox with the official AgentMail skill or a custom integration for sending, receiving, and managing conversations."
---
