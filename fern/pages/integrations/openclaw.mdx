---
title: OpenClaw
headline: Official OpenClaw Email Plugin
...
description: Install AgentMail as an official OpenClaw plugin with one command. Your agent gets its own inbox plus an allowlisted email channel it can be reached at.
---
