...
Your MCP client discovers tools directly from the hosted runtime. See the [runtime-generated contract](https://github.com/agentmail-to/agentmail-mcp/blob/main/mcp-manifest.json) for the current names and schemas.
