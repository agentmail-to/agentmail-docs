...
description: "Onboard AI agents to AgentMail with programmatic signup, agent-friendly documentation, MCP, official skills, and resources for popular coding assistants."
---
