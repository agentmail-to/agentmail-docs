...
description: "Connect AgentMail to Replit apps and agents, authenticate with an API key, and add programmable inbox, message, and email workflow capabilities through APIs."
---
