...
description: "Install and use the AgentMail CLI to create inboxes, send and receive email, manage threads, configure resources, and automate workflows from a terminal."
---
