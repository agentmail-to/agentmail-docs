...
description: "Use AgentMail with Stripe's Machine Payments Protocol so agents can pay per request, access MPP endpoints, and use email APIs without subscriptions at runtime."
---
