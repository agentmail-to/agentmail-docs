...
description: "Connect AgentMail to Google Agent Development Kit through MCP so ADK agents can create inboxes, exchange email, manage threads, and handle attachments."
---
