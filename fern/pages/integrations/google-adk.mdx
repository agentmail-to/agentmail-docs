...
`McpToolset` discovers the hosted server's current tools and schemas at connection time. Refer to the [runtime-generated contract](https://github.com/agentmail-to/agentmail-mcp/blob/main/mcp-manifest.json) instead of copying a fixed inventory into your application.
