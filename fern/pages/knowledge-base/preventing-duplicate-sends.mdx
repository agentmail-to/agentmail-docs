...
description: "Prevent duplicate AgentMail sends and resources by using client IDs, idempotent create operations, stable retry keys, and safe network retry patterns."
---
