...
description: "Add AgentMail SPF, DKIM, DMARC, MX, and tracking records in GoDaddy DNS, enter host values correctly, verify the domain, and troubleshoot setup issues."
---
