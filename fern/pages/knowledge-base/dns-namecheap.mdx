...
description: "Add AgentMail SPF, DKIM, DMARC, MX, and tracking records in Namecheap Advanced DNS, enter hosts correctly, verify the domain, and safely fix common issues."
---
