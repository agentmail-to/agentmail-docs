...
description: "Create an AgentMail API key in the Console, store it securely, authenticate SDK requests, and understand organization, Pod, and inbox-scoped access boundaries."
---
