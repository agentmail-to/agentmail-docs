...
description: "Configure SPF, DKIM, and DMARC records for AgentMail, verify domain authentication, prevent spoofing, and improve reliable inbox placement with DNS for agents."
---
