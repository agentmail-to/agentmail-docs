...
description: "Manage multi-turn email conversations with AgentMail threads so agents can preserve context, retrieve message history, reply correctly, and track state."
---
