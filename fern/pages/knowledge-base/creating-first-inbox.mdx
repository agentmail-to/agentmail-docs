...
description: "Create your first AgentMail inbox with the Python or TypeScript SDK, choose a default or custom domain, authenticate requests, and send a test email safely."
---
