...
**Use idempotency keys.** Prevent duplicate sends on retries by using the `clientId` parameter when creating inboxes, or by tracking sent message IDs in your application.
