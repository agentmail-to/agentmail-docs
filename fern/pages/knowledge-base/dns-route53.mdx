...
description: "Add AgentMail SPF, DKIM, DMARC, MX, and tracking records in AWS Route 53, configure record names and values, verify DNS, and troubleshoot setup issues."
---
