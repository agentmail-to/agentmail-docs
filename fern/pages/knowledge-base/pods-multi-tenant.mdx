...
description: "Use AgentMail Pods to isolate inboxes, domains, threads, drafts, API keys, and customer data across secure multi-tenant applications and agent platforms."
---
