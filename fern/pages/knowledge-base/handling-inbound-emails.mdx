...
description: "Compare AgentMail webhooks and WebSockets for handling inbound email, then choose the right real-time event delivery method for your agent workflow reliably."
---
