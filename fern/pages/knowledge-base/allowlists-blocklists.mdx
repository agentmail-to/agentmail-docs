...
description: "Configure AgentMail allowlists and blocklists to control which email addresses or domains an AI agent can send to, receive from, and reply to safely at scale."
---
