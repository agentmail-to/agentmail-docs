...
description: "Set up an AgentMail custom domain, add and verify DNS records, send from your brand, avoid provider conflicts, and improve trust and deliverability for agents."
---
