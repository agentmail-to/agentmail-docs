...
description: "Use AgentMail labels to track email workflow state, classify messages and threads, filter conversations, coordinate agents, and support reliable automation."
---
