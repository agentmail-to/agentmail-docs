...
description: "Avoid MX record conflicts when using AgentMail with Google Workspace, Outlook, or another provider by choosing a subdomain and preserving existing mail."
---
