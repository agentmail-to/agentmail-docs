...
description: "Fix an AgentMail domain stuck in pending or failed verification by checking DNS values, propagation, proxy settings, record conflicts, and retry timing."
---
