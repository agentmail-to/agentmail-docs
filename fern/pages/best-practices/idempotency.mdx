...
slug: idempotency
description: "Use AgentMail idempotency keys and client IDs to retry API requests safely, prevent duplicate resources or messages, and build reliable agent workflows."
---
