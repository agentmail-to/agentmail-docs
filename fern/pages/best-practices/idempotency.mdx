...
slug: idempotency
description: "Prevent duplicate AgentMail resources and email sends by using client IDs and Idempotency-Key headers to make retries safe across reliable API workflows."
---
