...
description: "Build a real-time sales email agent with AgentMail WebSockets that receives leads, understands replies, updates context, and responds without polling."
---
