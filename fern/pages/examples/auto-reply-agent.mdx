...
- Initial email acknowledgments
- Basic customer service automation
- Learning AgentMail fundamentals

<Callout intent="success">
**Time to complete:** 15 minutes

**Skill level:** Beginner (basic Python knowledge required)
</Callout>
...
|----------|-------------|---------|
| `AGENTMAIL_API_KEY` | Your AgentMail API key | `am_...` |
| `NGROK_AUTHTOKEN` | Your ngrok authentication token | `2a...` |
| `WEBHOOK_DOMAIN` | Your ngrok static domain (without https://) | `my-agent.ngrok-free.app` |
| `INBOX_USERNAME` | Username for your AgentMail inbox | `auto-reply` |
...
- If OpenAI API fails, automatically falls back to template reply
