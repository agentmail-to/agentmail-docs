...
description: "Build an AgentMail auto-reply agent that receives webhook events, reads incoming email, generates a response, and replies in the original thread in real time."
---
