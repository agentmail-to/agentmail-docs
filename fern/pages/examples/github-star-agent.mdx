...
slug: webhook-agent
description: "Build an event-driven agent that uses AgentMail to react to GitHub activity, send personalized emails, process replies, and continue threaded conversations."
---
