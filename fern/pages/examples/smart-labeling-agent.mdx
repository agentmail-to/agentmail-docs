...
description: "Build an AI email labeling agent with AgentMail that classifies incoming messages across multiple dimensions and applies labels for routing and analytics."
---
