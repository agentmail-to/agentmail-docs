...
description: "Connect to AgentMail WebSockets, subscribe to inboxes, and process real-time email events with complete Python and TypeScript examples for AI agents in minutes."
---
