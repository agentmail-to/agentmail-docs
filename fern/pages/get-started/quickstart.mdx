...
Copy one of the blocks below into Cursor or Claude for a complete, working AgentMail integration. Each includes setup, API reference, error handling, rate limiting, and idempotency guidance.
