...
slug: quickstart
description: "Create your first AgentMail inbox, install the Python or TypeScript SDK, protect your API key, and send and receive email with a working example step by step."
---
