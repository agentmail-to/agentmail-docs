...
title: Welcome
slug: welcome
description: "Start building with AgentMail, the email API for AI agents. Learn how to create inboxes, exchange messages, and connect email to autonomous workflows."
---
