...
slug: websockets
description: "Use AgentMail WebSockets for low-latency email events without polling, including authentication, inbox subscriptions, typed events, and reconnect handling."
---
