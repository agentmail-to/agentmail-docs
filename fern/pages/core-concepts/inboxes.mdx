...
slug: inboxes
description: "Learn how AgentMail inboxes give AI agents scalable email identities, including creation, metadata, custom domains, scoped API keys, and management at scale."
---
