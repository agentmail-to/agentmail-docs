...
slug: permissions
description: "Configure AgentMail API key permissions with a whitelist model that limits access by resource and operation across organization, Pod, or inbox scopes."
---
