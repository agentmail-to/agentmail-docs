...
slug: attachments
description: "Learn how AI agents send Base64 encoded files with AgentMail and retrieve attachments from incoming messages or complete conversation threads programmatically."
---
