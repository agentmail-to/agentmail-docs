---
title: Pods
description: "Learn how AgentMail Pods isolate inboxes, domains, threads, drafts, and API keys for secure multi-tenant applications and customer-specific agents at scale."
---
