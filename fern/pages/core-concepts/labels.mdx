...
slug: labels
description: "Use AgentMail labels to classify messages and threads, track workflow state, segment conversations, and filter email for reliable agent automation at scale."
---
