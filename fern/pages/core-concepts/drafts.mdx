...
slug: drafts
description: "Learn how agents can create, review, update, and send AgentMail drafts for approval flows, scheduled delivery, and human-in-the-loop email workflows at scale."
---
