...
slug: lists
description: "Use AgentMail allowlists and blocklists to control which addresses and domains an agent can send to, receive from, or reply to through the API safely at scale."
---
