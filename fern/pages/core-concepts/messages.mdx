...
<Callout intent="info" title="Sent via AgentMail footer">
...
<CodeBlocks>
   ...
   * - messages.getRaw(inboxId, messageId) -> { message_id, size, download_url, expires_at } (signed HTTPS CDN URL for .eml)
