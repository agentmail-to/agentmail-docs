---
tags: ["api-keys", "agentid", "sdk"]
---

## Summary

Build AgentID sign-in flows with a scoped P-256 credential while keeping private
key material in your own keystore. The API reference and SDKs now expose a
dedicated public-key lifecycle, and the new guide provides strict Python and
TypeScript approval helpers plus shared conformance vectors.
...
- **Safe SDK helpers**: Generate P-256 keys, register only public coordinates, pin the approval header and claims, and keep private keys below model context.
- **Portable conformance**: Verify RFC 7638 thumbprints and compact JWS acceptance and rejection across backend and SDK implementations.
