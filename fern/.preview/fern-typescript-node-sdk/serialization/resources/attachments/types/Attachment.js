...
const AttachmentInline_1 = require("./AttachmentInline");
exports.Attachment = core.serialization.object({
    ...
    filename: AttachmentFilename_1.AttachmentFilename.optional(),
    contentType: core.serialization.property("content_type", AttachmentContentType_1.AttachmentContentType.optional()),
    size: AttachmentSize_1.AttachmentSize,
    inline: AttachmentInline_1.AttachmentInline,
});
